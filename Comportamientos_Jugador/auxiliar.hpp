...
//Definiccion de structs necesarios para la practica
...
public:
  ...
  //Definicion funciones nivel 3
  list<Action> AlgoritmoAEstrella(const EstadoA &origen,const EstadoA &destino,
